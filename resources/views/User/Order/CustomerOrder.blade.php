...
<table id="example1" class="table table-bordered table-striped">        
  ...
  <tbody>
    ...
    @if(Auth::user()->id == $order -> user_id)
  	  ...
  	  <tr>
  	  	 <td style="text-align: center; color: 	black;">Cancel Order</td>
  	     ...
  	     <a class="btn" data-toggle="modal" data-target="#myModal1{{$order->id}}" style="text-decoration: none; color: black;">
									...
									<div class="modal-body">
									    ...
									    <table class="table table-bordered table-striped">        
							              ...
							              <tbody>
  											...
  											@foreach($customer_order as $vieworder)
                        @if(Auth::user()->id == $vieworder -> user_id)
							              	<tr> 			
							              		<td style="text-align: center; color: black;">{{$vieworder -> dish_name}}</td>
  							             		<td style="text-align: center; color: black;">{{$vieworder -> dish_qty}}</td>
  							              		<td style="text-align: center; color: black;">{{$vieworder -> dish_price}}</td>
  											    <td style="text-align: center; color:black;">{{$vieworders = $vieworder -> dish_price * $vieworder -> dish_qty}}</td>				        	
							              	</tr>
